  ...
  <div class="w-100 h-100 py-8 d-flex flex-column">
    ...
    <div class="mt-10">
      <app-data-table
        ...
        :on-row-clicked="onInvoiceInformationDialog"
      >
...
import InvoiceInformationDialog from "@/components/invoices/InvoiceInformationDialog.vue";
import SearchField from "../default/SearchField.vue";

const headers = [
  { title: "Invoice nr.", key: "id", style: "bold", align: "left" },
  { title: "OCR", key: "ocr", style: "bold", align: "left" },
  { title: "Customer Name", key: "name" },
  { title: "Number", key: "reference" },
...
const onInvoiceInformationDialog = function () {
